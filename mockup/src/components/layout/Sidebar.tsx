...
import { LayoutDashboard, Map, Truck, Activity, Wrench, Fuel, FlaskConical, ClipboardCheck, BarChart3, Settings, Users, MapPin, Calendar, MessageSquare, ChevronDown, ChevronRight } from 'lucide-react'
...
const navigation = [
  ...
  { name: 'Áreas & Rotas', href: '/areas', icon: MapPin },
    ...
    <aside className="w-64 bg-surface-1 border-r border-surface-3 flex flex-col">
      ...
      <div className="p-4 border-t border-surface-3">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-brand-700 flex items-center justify-center text-white text-xs font-bold">KM</div>
