...
export default function GruposEquipamento() {
  ...
  return (<>
    <DataTable columns={columns} data={data} title="Grupos de Equipamento" status="info" onAdd={()=>{setForm(empty);setEditing(null);setOpen(true)}} onEdit={r=>{setForm({codigo:r.codigo,nome:r.nome,tipo_operacao:r.tipo_operacao,cor:r.cor});setEditing(r);setOpen(true)}} onDelete={setDel} addLabel="Novo Grupo" />
